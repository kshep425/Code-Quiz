var questions = [
    ...
    {
        title:
        'What is this function called? var display = function(){ alert("Can alert from this?");}  display();  ',
    ...
    {
        title:
        "What do you need when a variable is defined outside the scope in reference and is accessed from some inner scope?",
    ...
    {
        title:
        "If you have string var str ='MyString' and you want to get character 'S', what do you use?",
    ...
    },
    {
        ...
        choices: [
        "Trick Question you can't disable animation",
